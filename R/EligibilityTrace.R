#' Eligibility trace for the weights of one neural layer.
#'
#' Eligibility trace for the weights of one neural layer, in principle
#' one weight matrix. Can also be used for lookup-table representations.
#
#' @param ninputs blabla
#' @param noutputs blabla
#' @param lambda.decay blabla
#'
#' @return Eligibility trace object
#' @export
